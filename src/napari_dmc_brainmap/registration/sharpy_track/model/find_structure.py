import os
from napari_dmc_brainmap.registration.sharpy_track.model.tools_slice import *
import tifffile
...
class sliceHandle():
    ...
    def parseJSON(self):
        ...
        # self.allen_location = np.array(self.regData['atlasLocation'])
        # self.pts_ref = np.array(self.regData['atlasDots'])
        # self.pts_sam = np.array(self.regData['sampleDots'])
