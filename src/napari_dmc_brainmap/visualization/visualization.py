...
def initialize_barplot_widget() -> FunctionGui:
    @magicgui(layout='vertical',
              ...
              save_data=dict(widget_type='CheckBox',
                            label='save data?',
                            value=False,
                            tooltip='tick to save data under directory and name'),
              save_data_name=dict(widget_type='LineEdit',
...
def initialize_brainsection_widget() -> FunctionGui:
    ...
    @magicgui(layout='vertical',
              ...
              bin_width_cells=dict(widget_type='SpinBox',
              ...
              group_diff_items_cells=dict(widget_type='LineEdit',
                                    ...
                                    value='item1-item2',
                                    tooltip='enter the two items you want to subtract from each other, item1-item2, e.g. experiment-contral'),
              # smooth_cells=dict(widget_type='CheckBox',
              #                  label='smoothing (cell density)',
              #                  value=False,
              #                  tooltip='tick to perform smoothing on cell density data '),
              # smooth_thresh_cells=dict(widget_type='LineEdit',
              #                    label='smoothing threshold (cell density)',
              #                    value='0.9',
              #                    tooltip='enter smoothing threshold between 0 and 1, increase to restrict area. advised: '
              #                            'to compare to data pre-smoothing.'),
              ...
              bin_width_proj=dict(widget_type='SpinBox',
              ...
              group_diff_items_proj=dict(widget_type='LineEdit',
                                          ...
                                          value='item1-item2',
                                          tooltip='enter the two items you want to subtract from each other, item1-item2, e.g. experiment-contral'),
              # smooth_proj=dict(widget_type='CheckBox',
              #               label='smoothing (projection density)',
              #               value=False,
              #               tooltip='tick to perform smoothing on projection density data '),
              # smooth_thresh_proj=dict(widget_type='LineEdit',
              #               label='smoothing threshold (projection density)',
              #               value='0.9',
              #               tooltip='enter smoothing threshold between 0 and 1, increase to restrict area. advised: '
              #                       'to compare to data pre-smoothing.'),
...
class VisualizationWidget(QWidget):
    ...
    def _do_brain_section_plot(self):
        ...
        for item in plot_item:
            if item == 'cells_density':
                data_dict[item] = load_data(input_path, atlas, animal_list, channels, data_type='cells',
