...
def initialize_brainsection_widget() -> FunctionGui:
    ...
    @magicgui(layout='vertical',
              ...
              hemisphere=dict(widget_type='ComboBox',
                              ...
                              choices=['ipsi', 'contra', 'both'],
                              value='both',
                              tooltip="select hemisphere to visualize (relative to injection side) - NOT IMPLEMENTED YET"),
              ...
              vmin=dict(widget_type='LineEdit',
              ...
              smooth_thresh=dict(widget_type='LineEdit',
                            label='smoothing threshold (projection density)',
                            value='0.9',
                            tooltip='enter smoothing threshold between 0 and 1, increase to restrict area. advised: to compare to data pre-smoothing.'),
