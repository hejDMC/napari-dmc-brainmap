...
def do_presegmentation(input_path, params_dict, channels, single_channel, regi_bool, regi_chan, preseg_params,
    ...
    for chan in channels:
        ...
        for im in seg_im_list:
            ...
            seg = remove_small_objects(bw_filled, min_size=preseg_params["minArea"],
                                       connectivity=1)  # min_size=3 a lot of small objects detected # ,min size 6 is still too small
